// ============================================================================
//  PRONTUÁRIO RÁPIDO - SERVIDOR (BACKEND) - v8.0
//
...
1. "discussao": este é o campo de RACIOCÍNIO CLÍNICO — o mais importante para o
   ...
   escreva de 4 a 8 linhas (até 10 se o caso for realmente complexo). Este
   bloco existe SEMPRE, em todo caso. É o que o médico lê no meio do plantão.
   Cada linha tem de DECIDIR alguma coisa. Entram aqui, conforme o caso:
   ...
   exato), e SÓ quando o caso for de fato AMBÍGUO: diagnóstico em aberto, achado
   que não fecha, red flag a descartar, dor torácica ou abdominal, sintoma
   neurológico. Quando existir, para CADA diferencial diga o que no caso o
...
const VERSAO_SERVIDOR = 'v8.0';
app.get('/', (req, res) => res.send(
    'Servidor do Prontuario Rapido ' + VERSAO_SERVIDOR + ' no ar. '
    + 'Linhas esperadas no server.js: 2953.'
));
