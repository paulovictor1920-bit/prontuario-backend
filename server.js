...
async function chamarClaude(promptFinal, imagens, sinal) {
    ...
    const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
            ...
            // v8.1.1 — PREFILL: a resposta do Claude já começa com "{". Assim ele
            // não tem como escrever preâmbulo ("Aqui está o JSON...") nem cerca
            // de código antes do objeto. O "{" é recolocado na leitura, abaixo.
            messages: [
    ...
    // v8.1.1: o "{" do prefill NÃO volta na resposta — a API devolve só a
    // continuação. Recolocamos aqui para o extrator receber o objeto inteiro.
...
const VERSAO_SERVIDOR = 'v8.1.1';
app.get('/', (req, res) => res.send(
    'Servidor do Prontuario Rapido ' + VERSAO_SERVIDOR + ' no ar. '
    + 'Linhas esperadas no server.js: 3235.'
));
