// ============================================================================
//  PRONTUÁRIO RÁPIDO - SERVIDOR (BACKEND) - v8.0.1
//
...
async function chamarClaude(promptFinal, imagens, sinal) {
    ...
    const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
            model: MODELO_CLAUDE,
            // v8.0: teto fixo. O Opus 5 pensa por padrão e o pensamento conta
            // DENTRO deste teto (pensamento + JSON); como a etapa extra vai
            // desligada, 12000 sobra para o documento inteiro. Subir o teto não
            // custa nada sozinho — só vira gasto se o modelo usar os tokens.
            max_tokens: 12000,
...
const VERSAO_SERVIDOR = 'v8.0.1';
app.get('/', (req, res) => res.send(
    'Servidor do Prontuario Rapido ' + VERSAO_SERVIDOR + ' no ar. '
    + 'Linhas esperadas no server.js: 2998.'
));
